...
const SvgFilesDocTextB = React.memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    width="1em"
    height="1em"
    ...
    {...props}
  >
    <g className="files-doc-text-b_svg__nc-icon-wrapper" fill="none">
      <g
        strokeLinecap="round"
        strokeWidth={1.5}
        stroke="currentColor"
...
export default SvgFilesDocTextB;
