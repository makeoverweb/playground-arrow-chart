...
const SvgShapesShapeObjectPlanet = React.memo(
    ...
    >
      <g fill="none">
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M14.828 4.929c1.563 3.905 1.563 10.237 0 14.142-1.562 3.905-4.094 3.905-5.656 0-1.563-3.905-1.563-10.237 0-14.142 1.562-3.905 4.094-3.905 5.656 0"
        />
        <path
          stroke="currentColor"
          strokeLinecap="round"
...
export default SvgShapesShapeObjectPlanet;
